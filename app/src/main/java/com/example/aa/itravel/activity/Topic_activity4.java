...
public class Topic_activity4 extends Activity {
    private Context mContext;

    String TAG = "TOPIC4_Activity";
    //s用来保存sessionid     发送refresh请求
    String session;
    String path = Network.URL+"gettopic4";
        ...
        public void handleMessage(Message msg){
            if(msg.what==1){
	            ...
	            if(com_list!=null){
		            ...
		            Toast.makeText(Topic_activity4.this,"没有话题评论", Toast.LENGTH_LONG).show();
	            }
        ...
        public void handleMessage(Message msg){
            if(msg.what==1){
                ...
                if(back.equals("true") ){
                    ...
                    Toast.makeText(Topic_activity4.this,"收藏成功", Toast.LENGTH_SHORT).show();
                }else{
                    right_icon.setImageResource(R.drawable.star_c);
                    Toast.makeText(Topic_activity4.this,"已收藏", Toast.LENGTH_SHORT).show();
                }
